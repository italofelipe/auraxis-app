...
- **Performance mobile** — bundle Android/iOS ≤ 12 MB (hard limit no CI), com alerta operacional a partir de 10 MB.
...
|:--------|:----------|:----|
| Bundle Android | ≤ 12 MB hard limit | `bundle-analysis` |
| Bundle iOS | ≤ 12 MB hard limit | `bundle-analysis` |
...
│   └── bundle-analysis   (comenta tamanho no PR; hard limit 12 MB)
│
