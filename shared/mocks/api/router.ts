...
const serializeWeeklyInsight = (): Record<string, unknown> => {
  return {
    insight: {
      ...
      items: weeklyInsightFixture.items,
      summary: weeklyInsightFixture.summary,
      period_type: weeklyInsightFixture.periodType,
      period_label: weeklyInsightFixture.periodLabel,
      ...
      model: weeklyInsightFixture.metadata.model,
      tokens_used: weeklyInsightFixture.metadata.tokensUsed,
      cost_usd: weeklyInsightFixture.metadata.costUsd,
      cached: weeklyInsightFixture.metadata.cached,
      context_version: weeklyInsightFixture.metadata.contextVersion,
    },
  };
};
